namespace Test.ItemTests
{
    ...
    public class ItemMappingTests
    {
        ...
        {
            MarketplaceItemDto marketplaceItemDto = mapper.Map<Item, MarketplaceItemDto>(this.item);
            ManageItemDto manageItemDto = mapper.Map<Item, ManageItemDto>(this.item);
            InventoryItemDto inventoryItemDto = mapper.Map<Item, InventoryItemDto>(this.item);
        ...
        {
            InventoryItemDto itemDto = mapper.Map<Item, InventoryItemDto>(this.item);
        ...
        {
            MarketplaceItemDto marketplaceItemDto = mapper.Map<Item, MarketplaceItemDto>(this.item);
            ItemDetailsDto itemDetailsDto = mapper.Map<Item, ItemDetailsDto>(this.item);
