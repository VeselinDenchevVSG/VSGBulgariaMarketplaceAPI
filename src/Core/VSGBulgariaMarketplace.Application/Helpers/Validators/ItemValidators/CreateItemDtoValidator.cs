namespace VSGBulgariaMarketplace.Application.Helpers.Validators.ItemValidators
{
    ...
    public class CreateItemDtoValidator : AbstractValidator<CreateItemDto>
    {
        ...
        {
            RuleFor(i => i.Code).NotEmptyWithMessage<CreateItemDto, string, Item>(ITEM_CODE)
            ...
            RuleFor(i => i.Name).NotEmptyWithMessage<CreateItemDto, string, Item>(ITEM_NAME)
                                .MaximumLength(ITEM_CODE_MAX_STRING_LENGTH)
                                .WithMessage(string.Format(ITEM_PROPERTY_CAN_NOT_BE_LONGER_THAN_ERROR_MESSAGE_TEMPLATE,
            ...
            RuleFor(i => i.Quantity).NotEmptyWithMessage<CreateItemDto, short, Item>(ITEM_QUANTITY_COMBINED)
            ...
            When(i => i.QuantityForSale.HasValue, () =>
            {
                ...
                RuleFor(i => i.Price).NotEmptyWithMessage<CreateItemDto, decimal?, Item>(ITEM_PRICE,
